...
d3.csv('data/disasters.csv')
  ...
  for(let i = 0; i<data.length; i++){
  	...
  	let cy = getYearPosition(data[i].year, gapBetweenTimelines, startOfTimelinesY ); //******* don't use 0, use getYearPosition
  ...
  //domainx1 to domainx2, maps it to range x1/2, value
